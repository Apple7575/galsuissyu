...
export const categories:Record<string,{label:string;icon:string;color:string}>={all:{label:'전체',icon:'◈',color:'#477764'},attraction:{label:'명소',icon:'◈',color:'#cb7052'},culture:{label:'문화',icon:'▥',color:'#a18250'},park:{label:'공원·쉼터',icon:'♧',color:'#5b854f'},food:{label:'식당·카페',icon:'☕',color:'#a97153'},shopping:{label:'쇼핑',icon:'▱',color:'#a47d98'},station:{label:'역',icon:'▣',color:'#6e7fab'},elevator:{label:'엘리베이터',icon:'↕',color:'#3f8074'},toilet:{label:'화장실',icon:'WC',color:'#508c80'},public:{label:'생활시설',icon:'＋',color:'#758193'}};
